...
open class BinaryenRootPlugin : org.jetbrains.kotlin.gradle.targets.js.binaryen.BinaryenRootPlugin() {
    override fun apply(project: Project) {
        ...
        val settings = project.extensions.create(
            BinaryenRootExtension.Companion.EXTENSION_NAME,
    ...
    private fun ExtensionContainer.createBinaryenRootEnvSpec(): BinaryenRootEnvSpec {
        return create(
            BinaryenRootEnvSpec.Companion.EXTENSION_NAME,
    ...
    companion object {
        ...
        fun apply(rootProject: Project): BinaryenRootExtension {
            ...
            return rootProject.extensions.getByName(BinaryenRootExtension.Companion.EXTENSION_NAME) as BinaryenRootExtension
        }

        val Project.kotlinBinaryenExtension: BinaryenRootExtension
            get() = extensions.getByName(BinaryenRootExtension.Companion.EXTENSION_NAME).castIsolatedKotlinPluginClassLoaderAware()
    }
}