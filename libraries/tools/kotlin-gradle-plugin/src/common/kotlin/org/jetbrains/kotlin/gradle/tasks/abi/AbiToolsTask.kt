...
internal abstract class AbiToolsTask : DefaultTask(), UsesClassLoadersCachingBuildService {
    ...
    companion object {
         ...
         *
         * E.g. task 'foo' for variant "" (empty string) will have name "foo", and for variant "extra" will be "fooExtra".
         */
        internal fun composeTaskName(baseName: String, variantName: String): String {
            val suffix = if (variantName == AbiValidationVariantSpec.BUILT_IN_VARIANT_NAME) {
                ""
            } else {
