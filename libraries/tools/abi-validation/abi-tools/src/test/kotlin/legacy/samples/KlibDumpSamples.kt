...
class KlibDumpSamples {
    ...
    fun mergeDumps() {
        ...
        val mergedDump = AbiTools.klib.emptyDump().apply {
            merge(linuxX64Dump)
    ...
    fun mergeDumpObjects() {
        ...
        val mergedDump = AbiTools.klib.emptyDump()
        mergedDump.merge(AbiTools.klib.parse(linuxArm64Dump))
        mergedDump.merge(AbiTools.klib.parse(linuxX64Dump).also { it.setCustomName("linuxX86_64") })
        val mergedDumpContent = buildString { mergedDump.printTo(this) }
    ...
    fun updateMergedDump() {
        ...
        mergedDump.replace(AbiTools.klib.parse(newLinuxX64Dump).also { it.setCustomName("linuxX86_64") })
    ...
    fun extractTargets() {
        ...
        val dump = AbiTools.klib.parse(mergedDump)
        assertEquals(
    ...
    fun inferDump() {
        ...
        val inferredIosArm64Dump = inferAbi(
            ...
            supportedTargetDumps = listOf(AbiTools.klib.parse(linuxDump)),
            oldMergedDump = AbiTools.klib.parse(oldMergedDump))
