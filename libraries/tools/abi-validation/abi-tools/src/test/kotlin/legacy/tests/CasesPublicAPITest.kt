...
import org.jetbrains.kotlin.abi.tools.extractAnnotatedPackages
import org.jetbrains.kotlin.abi.tools.filterOutAnnotated
import org.jetbrains.kotlin.abi.tools.filterOutNonPublic
import org.jetbrains.kotlin.abi.tools.loadApiFromJvmClasses
import org.junit.*
...
class CasesPublicAPITest {
    ...
    @Test
    fun companions() {
        snapshotAPIAndCompare(testName.methodName, setOf("cases/companions/PrivateApi"))
    }

    @Test
    fun default() {
        snapshotAPIAndCompare(testName.methodName, setOf("cases/default/PrivateApi"))
    }
    ...
    fun marker() {
        snapshotAPIAndCompare(
            testName.methodName,
            setOf("cases/marker/HiddenField", "cases/marker/HiddenProperty", "cases/marker/HiddenMethod")
        )
    }
    ...
    fun packageAnnotations() {
        snapshotAPIAndCompare(testName.methodName, setOf("cases/packageAnnotations/PrivateApi"))
    }
