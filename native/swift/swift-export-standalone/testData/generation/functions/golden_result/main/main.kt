...
public fun Foo_extVar_set__TypesOfArguments__Swift_String_Swift_String__(self: kotlin.native.internal.NativePtr, receiver: kotlin.native.internal.NativePtr, newValue: kotlin.native.internal.NativePtr): Unit {
    val __self = kotlin.native.internal.ref.dereferenceExternalRCRef(self) as Foo
    val __receiver = interpretObjCPointer<kotlin.String>(receiver)
    val __newValue = interpretObjCPointer<kotlin.String>(newValue)
    __self.run { __receiver.extVar = __newValue }
}
...
public fun __root___foo_set__TypesOfArguments__Swift_Int32_Swift_String__(receiver: Int, newValue: kotlin.native.internal.NativePtr): Unit {
    val __receiver = receiver
    val __newValue = interpretObjCPointer<kotlin.String>(newValue)
    __receiver.foo = __newValue
}

@ExportedBridge("__root___foo_set__TypesOfArguments__Swift_Int32_opt__Swift_String__")
public fun __root___foo_set__TypesOfArguments__Swift_Int32_opt__Swift_String__(receiver: kotlin.native.internal.NativePtr, newValue: kotlin.native.internal.NativePtr): Unit {
    val __receiver = if (receiver == kotlin.native.internal.NativePtr.NULL) null else interpretObjCPointer<Int>(receiver)
    val __newValue = interpretObjCPointer<kotlin.String>(newValue)
    __receiver.foo = __newValue
}
...
public fun __root___foo_set__TypesOfArguments__main_Foo_Swift_String__(receiver: kotlin.native.internal.NativePtr, newValue: kotlin.native.internal.NativePtr): Unit {
    val __receiver = kotlin.native.internal.ref.dereferenceExternalRCRef(receiver) as Foo
    val __newValue = interpretObjCPointer<kotlin.String>(newValue)
    __receiver.foo = __newValue
}
...
public fun __root___foo_set__TypesOfArguments__main_Foo_opt__Swift_String__(receiver: kotlin.native.internal.NativePtr, newValue: kotlin.native.internal.NativePtr): Unit {
    val __receiver = if (receiver == kotlin.native.internal.NativePtr.NULL) null else kotlin.native.internal.ref.dereferenceExternalRCRef(receiver) as Foo
    val __newValue = interpretObjCPointer<kotlin.String>(newValue)
    __receiver.foo = __newValue
}
