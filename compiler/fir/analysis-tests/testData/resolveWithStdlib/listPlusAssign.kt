...
fun Any.modify() {
    <!CANNOT_INFER_PARAMETER_TYPE!><!WRAPPED_LHS_IN_ASSIGNMENT_WARNING{PSI}!>(<!VARIABLE_EXPECTED{PSI}!>this <!UNCHECKED_CAST!>as List<Int><!><!>)<!> <!UNRESOLVED_REFERENCE_WRONG_RECEIVER!>+=<!> 42<!>
}
