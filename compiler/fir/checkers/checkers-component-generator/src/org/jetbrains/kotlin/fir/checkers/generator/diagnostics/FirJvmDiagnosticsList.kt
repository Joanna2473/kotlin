...
object JVM_DIAGNOSTICS_LIST : DiagnosticList("FirJvmErrors") {
    val DECLARATIONS by object : DiagnosticGroup("Declarations") {
        ...
        val JVM_EXPOSE_BOXED_MUST_BE_EXPLICIT by error<PsiElement>()
        val JVM_EXPOSE_BOXED_MUST_BE_EXPLICIT_WARNING by warning<PsiElement>()
        val JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT by error<PsiElement>()
        val JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT_WARNING by warning<PsiElement>()
