...
object JVM_DIAGNOSTICS_LIST : DiagnosticList("FirJvmErrors") {
    ...
    val ANNOTATIONS by object : DiagnosticGroup("annotations") {
        ...
        val OVERLOADS_ANNOTATION_CLASS_CONSTRUCTOR by deprecationError<KtAnnotationEntry>(null)
    ...
    val MISC by object : DiagnosticGroup("Misc") {
        ...
        val CONCURRENT_HASH_MAP_CONTAINS_OPERATOR by deprecationError<PsiElement>(null)
        val SPREAD_ON_SIGNATURE_POLYMORPHIC_CALL by deprecationError<PsiElement>(null, PositioningStrategy.SPREAD_OPERATOR)
