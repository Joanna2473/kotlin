...
object FirJvmErrors {
    ...
    val JVM_EXPOSE_BOXED_REDUNDANT_NAME: KtDiagnosticFactory0 = KtDiagnosticFactory0("JVM_EXPOSE_BOXED_REDUNDANT_NAME", WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class)
    val JVM_EXPOSE_BOXED_CANNOT_EXPOSE_SUSPEND: KtDiagnosticFactory0 = KtDiagnosticFactory0("JVM_EXPOSE_BOXED_CANNOT_EXPOSE_SUSPEND", WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class)
    ...
    val JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT: KtDiagnosticFactory0 = KtDiagnosticFactory0("JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT", ERROR, SourceElementPositioningStrategies.DEFAULT, PsiElement::class)
    val JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT_WARNING: KtDiagnosticFactory0 = KtDiagnosticFactory0("JVM_EXPOSE_BOXED_METHOD_MUST_BE_EXPLICIT_WARNING", WARNING, SourceElementPositioningStrategies.DEFAULT, PsiElement::class)
