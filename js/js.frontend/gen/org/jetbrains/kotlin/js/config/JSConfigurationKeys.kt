...
object JSConfigurationKeys {
    ...
    @JvmField
    val CALL_MAIN = CompilerConfigurationKey.create<Boolean>("Specify whether the 'main' function should be called upon execution.")
...
var CompilerConfiguration.callMain: Boolean
    get() = getBoolean(JSConfigurationKeys.CALL_MAIN)
