...
object BuiltinSpecialProperties {
    val PROPERTY_FQ_NAME_TO_JVM_GETTER_NAME_MAP: Map<FqName, Name> = mapOf(
        ...
        StandardNames.FqNames.atomicIntArray_concurrent.child("size") to Name.identifier("length"),
        StandardNames.FqNames.atomicLongArray_concurrent.child("size") to Name.identifier("length"),
        StandardNames.FqNames.atomicArray_concurrent.child("size") to Name.identifier("length"),
    )
